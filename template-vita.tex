...
\begin{publist}
\pubitem{``Can Two Temporally and Spatially Coincident Picosecond Laser Pulses Enhance Proton and Electron Acceleration?'' (in preparation)}
\pubitem{``Towards Automated Learning with Ultra-Intense Laser Systems Operating in the kHz Repetition Rate Regime'' (in review)}
\pubitem{``Towards Intelligent Control of MeV Energy Electrons and Protons from kHz Repetition Rate Ultra-Intense Laser Interactions'' (in review)}
